...
- Mid-combat at [[The Frozen Riverbank]] against werewolves, werebears, and an enormous panther, after the corpses scattered along the bank rose and dragged [[Gribnik Mossfoot]], [[Thol]], and [[Thalrik Lastfeast]] toward the water
- [[Thol]] and his mount are in the river; the mount held its action, let Thol climb on, then teleported them up to the cliff where the panther is
- Play resumes with the decision of what Thol's mount does next, on the cliff facing the panther

## Open threads

- A gnomish scream came from the moving corpses at the riverbank, and [[Torin Turen]] is alone in that same forest. Why?
- What killed a field of [[Bane]]'s soldiers and that many beasts at the riverbank, and whether the panther is a were-creature, a servant of [[Malar]], or something else
- [[The Abyssal Orb]] spoke for the first time, only to [[Thalrik Lastfeast]], saying "free me". Why him, and what it wants freeing from
...
grant asked us if we wanted to chase it or not and we chose to chase it and we chased it to a new battle zone: the tree of pain
we beat the beast of malar at the tree of pain